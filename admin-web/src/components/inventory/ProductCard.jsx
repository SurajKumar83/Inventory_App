      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1">
          <div className="flex items-start justify-between">
            ...
            <p className="text-lg font-bold text-dukaan-green-600">
          ...
          <div className="mt-4 flex gap-2">
            <button
              ...
              className="flex-1 px-3 py-2 text-sm font-medium text-dukaan-green-600 bg-dukaan-green-50 rounded-lg hover:bg-dukaan-green-100 transition-colors"
            >
              Adjust Stock
            </button>
            <button
